...
# HIDE ALL STREAMLIT BRANDING (footer, menu, badge, header clutter)
st.markdown("""
<style>
    ...
    /* Hide Streamlit Community Cloud badge (bottom-right) */
    .css-1v0mbdj {display: none !important;}
    .st-emotion-cache-1a6n9b8 {display: none !important;}
    .stAppDeployButton {display: none !important;}
    
    /* Optional: Remove top header bar completely */
    header {visibility: hidden !important;}
    .css-1rsyylj {display: none !important;}
</style>
