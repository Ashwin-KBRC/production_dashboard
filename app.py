...
# ========================================
# ANALYTICS — FINAL FIX: MONTHLY ACCUMULATIVE = FINAL DAY
# ========================================
elif mode == "Analytics":
    ...
    if len(saved) < 2:
        ...
        if filtered_df.empty:
            ...
            # === WEEKLY: Custom week from start_date ===
            ...
            # === ACCUMULATIVE = FINAL DAY OF PERIOD ===
            # Monthly: Max date in month per plant
            ...
            # Weekly: Max date in week per plant
            ...
            st.subheader(f"Weekly Accumulative (Final Day) — {start_date} to {end_date}")
            ...
            st.subheader(f"Monthly Accumulative (Final Day) — {start_date} to {end_date}")
