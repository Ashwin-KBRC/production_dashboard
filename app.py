...
# ========================================
# UPLOAD MODE (unchanged + Mutla merge in display)
# ========================================
    ...
    if uploaded:
        ...
        if missing:
            ...
            if confirm and st.button("Upload & Save"):
                ...
                df_display = merge_mutla_plants(df_display)  # ← Merge Mutla
                ...
                st.download_button("Download Excel", excel_file, f"report_{selected_date.strftime('%Y-%m-%d')}.xlsx",
                                 "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")

# ========================================
# VIEW HISTORICAL DATA → BIG BOX + MUTLA MERGED
# ========================================
    ...
    if not saved_list:
        ...
        df_hist_disp = merge_mutla_plants(df_hist_disp)  # ← Merge Mutla
        ...
        st.download_button("Download Excel", excel_file, f"report_{selected}.xlsx",
                         "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
...
# ========================================
    ...
    if len(saved) < 2:
        ...
        if filtered_df.empty:
            ...
            filtered_df = merge_mutla_plants(filtered_df)  # ← Merge Mutla
...
# ========================================
# PLOT HELPERS (unchanged — all your original functions below)
# ========================================
# [All your pie_chart, bar_chart, line_chart, area_chart, aggregated_bar_chart functions remain exactly the same]
# ... (copy-paste them here exactly as you had them)
